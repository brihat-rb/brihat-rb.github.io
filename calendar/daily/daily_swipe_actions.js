...
document.getElementById("body_element").addEventListener('touchstart', handleTouchStart, false);
document.getElementById("body_element").addEventListener('touchmove', handleTouchMove, false);
